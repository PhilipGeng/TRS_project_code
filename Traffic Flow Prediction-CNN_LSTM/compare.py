...
#plt.xticks(pd.date_range(date_1,date_2,freq='5min'))#time step
...
plt.sca(ax1)
plt.title(u'LCTFP')
plt.ylabel(u'Traffic flow')
plt.ylim((0, 900))
plt.yticks(np.linspace(0, 900, 10))
plt.xticks(rotation=30)
l1, = ax1.plot(dates, y_test[56:344, 16], label=u"Real value")
...
plt.yticks(np.linspace(0, 900, 10))
plt.xticks(rotation=30)
l3, = ax2.plot(dates, y_test[56:344, 16], label=u"Real value")
...
plt.yticks(np.linspace(0, 900, 10))
plt.xticks(rotation=30)
l5, = ax3.plot(dates, y_test[56:344, 16], label=u"Real value")
